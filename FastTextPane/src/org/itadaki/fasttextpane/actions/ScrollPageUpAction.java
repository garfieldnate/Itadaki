 ...
 */
public class ScrollPageUpAction extends AbstractAction implements Action {
	...
	public void actionPerformed(ActionEvent e) {
		...
		this.fastTextView.scrollPage (true);
	 ...
	 * @param fastTextView
	 */
	public ScrollPageUpAction (FastTextView fastTextView) {

		super ("scroll-up-page");
