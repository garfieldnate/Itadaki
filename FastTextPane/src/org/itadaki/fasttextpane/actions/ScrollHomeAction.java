...
/**
 * Action to scroll a FastTextView to Home
 */
public class ScrollHomeAction extends AbstractAction implements Action {
	 ...
	 * @param fastTextView
	 */
	public ScrollHomeAction (FastTextView fastTextView) {
