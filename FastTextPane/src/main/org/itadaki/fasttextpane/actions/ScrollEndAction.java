...
/**
 * Action to scroll a FastTextView to End
 */
public class ScrollEndAction extends AbstractAction implements Action {
	 ...
	 * @param fastTextView
	 */
	public ScrollEndAction (FastTextView fastTextView) {
