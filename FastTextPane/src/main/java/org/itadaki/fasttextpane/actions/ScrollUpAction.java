...
/**
 * Action to scroll a FastTextView up one line
 */
public class ScrollUpAction extends AbstractAction implements Action {
	 ...
	 * @param fastTextView
	 */
	public ScrollUpAction (FastTextView fastTextView) {
