...
public class MoveUpAction extends AbstractAction implements ListSelectionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		this.dictionariesTableModel.moveUpDictionaryAtIndex (selectionIndex);
	...
	public void valueChanged (ListSelectionEvent e) {
		...
		if (!this.dictionariesTable.getSelectionModel().isSelectionEmpty()
				&& this.dictionariesTable.getSelectionModel().getMinSelectionIndex() > 0)
		{
	 ...
	 */
	public MoveUpAction (JTable dictionariesTable, DictionariesTableModel dictionariesTableModel) {
