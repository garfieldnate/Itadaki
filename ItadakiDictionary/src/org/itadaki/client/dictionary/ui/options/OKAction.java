...
public class OKAction extends AbstractAction {
	...
	public void actionPerformed (ActionEvent e) {
		...
		Settings.getInstance().putDictionarySettings (this.dictionariesTableModel.getDictionarySettings());
	 ...
	 */
	public OKAction (OptionsWindow parent, DictionariesTableModel dictionariesTableModel) {
